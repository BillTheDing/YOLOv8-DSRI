...
def get_params():
    params = {
        # 'weight': '/root/autodl-tmp/yolov8-main/test/yolov8.pt', # 现在只需要指定权重即可,不需要指定cfg
        # 'weight': '/root/autodl-tmp/yolov8-main/test/DWR.pt', # 现在只需要指定权重即可,不需要指定cfg
        # 'weight': '/root/autodl-tmp/yolov8-main/test/InnerIoU.pt', # 现在只需要指定权重即可,不需要指定cfg
        # 'weight': '/root/autodl-tmp/yolov8-main/test/LSKA.pt', # 现在只需要指定权重即可,不需要指定cfg
        # 'weight': '/root/autodl-tmp/yolov8-main/test/rfa(1).pt', # 现在只需要指定权重即可,不需要指定cfg
        'weight': '/root/autodl-tmp/yolov8-main/test/final.pt', # 现在只需要指定权重即可,不需要指定cfg
        'device': 'cuda:0',
        'method': 'RandomCAM', # GradCAMPlusPlus, GradCAM6, XGradCAM6, EigenCAM6, HiResCAM, LayerCAM, RandomCAM6, EigenGradCAM
...
if __name__ == '__main__':
    ...
    model(r'/root/autodl-tmp/yolov8-main/test/img/IMG_20220927_134813.jpg', 'result-final')